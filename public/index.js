...
class AnswersCreator {
  ...
  makeAnswerElement() {
    ...
    let answers = this.array.concat(this.quizzs[this.index].incorrect_answers);
  ...
  setNextQuestion(e, answer) {
    ...
    if (main.gameState.index === 10) {
      ...
      const questionNumber = new QuestionTitle(this.h1, '問題', this.gameState);
      questionNumber.setTitle();
      const createQuestion = new QuestionCreator(
        this.gameState,
        this.questionElement
